...
<head>
    ...
    <title>Login - MindMatch Library</title>
...
<body class="antialiased min-h-screen flex text-[#1e1b16]">
    ...
    <div class="hidden lg:flex lg:w-[45%] relative bg-black shadow-2xl z-10">
        ...
        <div class="relative z-10 flex flex-col justify-end p-16 xl:p-20 w-full text-white">
            <h2 class="font-heading text-5xl font-bold mb-6 tracking-tight leading-tight">Welcome Back to<br/>Your Sanctuary</h2>
            <p class="text-lg text-white/80 max-w-md leading-relaxed">Resume your reading journey right where you left off in quiet focus.</p>
        </div>
    </div>

    <!-- Right Side: Form -->
    <div class="w-full lg:w-[55%] flex items-center justify-center p-8 sm:p-16 xl:p-24 relative">
        <div class="w-full max-w-md">
            
            <a href="{{ route('dashboard') }}" class="inline-flex items-center gap-3 mb-12 text-[#775a19] hover:text-[#c5a059] transition-colors group">
            ...
            <h1 class="font-heading text-6xl font-bold mb-4 tracking-tight">Login</h1>
            <p class="text-[#7f7667] mb-12 text-lg">Step into the quiet alcove. Enter your details.</p>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus class="w-full bg-[#fcfcd4] border border-[#e9e1d8] text-[#1e1b16] rounded-xl py-4 px-5 focus:outline-none focus:ring-2 focus:ring-[#c5a059] focus:border-transparent transition-all shadow-sm placeholder:text-[#a89d8c]">
            ...
            <p class="mt-12 text-center text-[#7f7667]">
                ...
                <a href="{{ route('register') }}" class="font-bold text-[#775a19] hover:text-[#c5a059] transition-colors underline underline-offset-4 decoration-[#e9e1d8] hover:decoration-[#c5a059]">Sign Up</a>
            </p>
        </div>
    </div>
</body>
